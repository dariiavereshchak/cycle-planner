...
import { attemptSignup, validateEmail, validatePassword } from "@/lib/auth";

// ─────────────────────────────────────────────
// Sub-components (self-contained for this page)
// ─────────────────────────────────────────────
...
const [loading, setLoading] = useState(false);
  ...
  // ✅ New: confirm password check (only if password itself is valid)
  if (!passwordErr && password !== confirmPassword) {
  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    const result = attemptSignup(email, password);
    setLoading(false);
    ...
    <>
      ...
      >
        ...
        <div className="mb-10 text-center">
          ...
          <p className="text-[14px] leading-snug" style={{ fontFamily: "'Nunito', sans-serif", color: "#B5ADA8" }}>
        ...
        >
          ...
          <div className="text-center mb-8">
            ...
            <p className="text-sm" style={{ fontFamily: "'Nunito', sans-serif", color: "#9A8F86" }}>
              Begin your journey with EssenSHEal
            </p>
          </div>
